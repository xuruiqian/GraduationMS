...
<head>
    ...
    <!--[if lt IE 9]>
    <script src='Contents/Scripts/html5shiv.js' type='text/javascript'></script>
    <![endif]-->
    <link href='Contents/Style/bootstrap/bootstrap.css' media='all' rel='stylesheet' type='text/css'/>
    <link href='Contents/Style/bootstrap/bootstrap-responsive.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / jquery ui -->
    <link href='Contents/Style/jquery_ui/jquery-ui-1.10.0.custom.css' media='all' rel='stylesheet' type='text/css'/>
    <link href='Contents/Style/jquery_ui/jquery.ui.1.10.0.ie.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / switch buttons -->
    <link href='Contents/Style/plugins/bootstrap_switch/bootstrap-switch.css' media='all' rel='stylesheet'
          type='text/css'/>
    <!-- / xeditable -->
    <link href='Contents/Style/plugins/xeditable/bootstrap-editable.css' media='all' rel='stylesheet' type='text/css'/>
    <link href='Contents/Style/plugins/common/bootstrap-wysihtml5.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / wysihtml5 (wysywig) -->
    <link href='Contents/Style/plugins/common/bootstrap-wysihtml5.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / jquery file upload -->
    <link href='Contents/Style/plugins/jquery_fileupload/jquery.fileupload-ui.css' media='all' rel='stylesheet'
          type='text/css'/>
    <!-- / full calendar -->
    <link href='Contents/Style/plugins/fullcalendar/fullcalendar.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / select2 -->
    <link href='Contents/Style/plugins/select2/select2.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / mention -->
    <link href='Contents/Style/plugins/mention/mention.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / tabdrop (responsive tabs) -->
    <link href='Contents/Style/plugins/tabdrop/tabdrop.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / jgrowl notifications -->
    <link href='Contents/Style/plugins/jgrowl/jquery.jgrowl.min.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / datatables -->
    <link href='Contents/Style/plugins/datatables/bootstrap-datatable.css' media='all' rel='stylesheet'
          type='text/css'/>
    <!-- / dynatrees (file trees) -->
    <link href='Contents/Style/plugins/dynatree/ui.dynatree.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / color picker -->
    <link href='Contents/Style/plugins/bootstrap_colorpicker/bootstrap-colorpicker.css' media='all' rel='stylesheet'
          type='text/css'/>
    <!-- / datetime picker -->
    <link href='Contents/Style/plugins/bootstrap_datetimepicker/bootstrap-datetimepicker.min.css' media='all'
          rel='stylesheet' type='text/css'/>
    <!-- / daterange picker) -->
    <link href='Contents/Style/plugins/bootstrap_daterangepicker/bootstrap-daterangepicker.css' media='all'
          rel='stylesheet' type='text/css'/>
    <!-- / flags (country flags) -->
    <link href='Contents/Style/plugins/flags/flags.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / slider nav (address book) -->
    <link href='Contents/Style/plugins/slider_nav/slidernav.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / fuelux (wizard) -->
    <link href='Contents/Style/plugins/fuelux/wizard.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- / flatty theme -->
    <link href='Contents/Style/light-theme.css' id='color-settings-body-color' media='all' rel='stylesheet'
          type='text/css'/>
    <!-- / demo -->
    <link href='Contents/Style/demo.css' media='all' rel='stylesheet' type='text/css'/>
            ...
            <div class='container-fluid'>
                ...
                <ul class='nav pull-right'>
                    <li class='dropdown light only-icon'>
                        ...
                        <ul class='dropdown-menu color-settings'>
                            <li class='color-settings-body-color'>
                                ...
                                <a data-change-to='Contents/Style/light-theme.css' href='#'>
                                    Light
                                    <small>(default)</small>
                                </a>
                                <a data-change-to='Contents/Style/dark-theme.css' href='#'>
                                    Dark
                                </a>
                                <a data-change-to='Contents/Style/dark-blue-theme.css' href='#'>
                                    Dark blue
                                </a>
                            </li>
                            <li class='divider'></li>
                    ...
                    <li class='dropdown dark user-menu'>
                        <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
                            <img alt='Mila Kunis' height='23' src='Contents/Images/avatar.jpg' width='23'/>
                ...
                <li>
                    ...
                    <ul class='nav nav-stacked'>
                        ...
                        <li class=''>
                            <a href='user_profile.html'>
                                <i class='icon-user'></i>
                                <span>com.gt.data.User profile</span>
                            </a>
                        </li>
                        <li class=''>
                            <a href='err404.html'>
                                                    ...
                                                    <li>
                                                        <div class='avatar pull-left'>
                                                            <img alt='Avatar' height='23'
                                                                 src='Contents/Images/avatar.jpg' width='23'/>
                                                        </div>
                                    ...
                                    <div class='box-content box-no-padding'>
                                        <div class='scrollable' data-scrollable-height='300'
                                            ...
                                            <ul class='unstyled list-hover list-striped'>
                                                <li class='message'>
                                                    <div class='avatar'>
                                                        <img alt='Avatar' height='23' src='Contents/Images/avatar.jpg'
                                                             width='23'/>
                                                    </div>
...
<!-- / jquery -->
<script src='Contents/Scripts/jquery/jquery.min.js' type='text/javascript'></script>
<!-- / jquery mobile events (for touch and slide) -->
<script src='Contents/Scripts/plugins/mobile_events/jquery.mobile-events.min.js' type='text/javascript'></script>
<!-- / jquery migrate (for compatibility with new jquery) -->
<script src='Contents/Scripts/jquery/jquery-migrate.min.js' type='text/javascript'></script>
<!-- / jquery ui -->
<script src='Contents/Scripts/jquery_ui/jquery-ui.min.js' type='text/javascript'></script>
<!-- / bootstrap -->
<script src='Contents/Scripts/bootstrap/bootstrap.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/flot/excanvas.js' type='text/javascript'></script>
<!-- / sparklines -->
<script src='Contents/Scripts/plugins/sparklines/jquery.sparkline.min.js' type='text/javascript'></script>
<!-- / flot charts -->
<script src='Contents/Scripts/plugins/flot/flot.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/flot/flot.resize.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/flot/flot.pie.js' type='text/javascript'></script>
<!-- / bootstrap switch -->
<script src='Contents/Scripts/plugins/bootstrap_switch/bootstrapSwitch.min.js' type='text/javascript'></script>
<!-- / fullcalendar -->
<script src='Contents/Scripts/plugins/fullcalendar/fullcalendar.min.js' type='text/javascript'></script>
<!-- / datatables -->
<script src='Contents/Scripts/plugins/datatables/jquery.dataTables.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/datatables/jquery.dataTables.columnFilter.js' type='text/javascript'></script>
<!-- / wysihtml5 -->
<script src='Contents/Scripts/plugins/common/wysihtml5.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/common/bootstrap-wysihtml5.js' type='text/javascript'></script>
<!-- / select2 -->
<script src='Contents/Scripts/plugins/select2/select2.js' type='text/javascript'></script>
<!-- / color picker -->
<script src='Contents/Scripts/plugins/bootstrap_colorpicker/bootstrap-colorpicker.min.js'
        type='text/javascript'></script>
<!-- / mention -->
<script src='Contents/Scripts/plugins/mention/mention.min.js' type='text/javascript'></script>
<!-- / input mask -->
<script src='Contents/Scripts/plugins/input_mask/bootstrap-inputmask.min.js' type='text/javascript'></script>
<!-- / fileinput -->
<script src='Contents/Scripts/plugins/fileinput/bootstrap-fileinput.js' type='text/javascript'></script>
<!-- / modernizr -->
<script src='Contents/Scripts/plugins/modernizr/modernizr.min.js' type='text/javascript'></script>
<!-- / retina -->
<script src='Contents/Scripts/plugins/retina/retina.js' type='text/javascript'></script>
<!-- / fileupload -->
<script src='Contents/Scripts/plugins/fileupload/tmpl.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/fileupload/load-image.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/fileupload/canvas-to-blob.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/fileupload/jquery.iframe-transport.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/fileupload/jquery.fileupload.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/fileupload/jquery.fileupload-fp.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/fileupload/jquery.fileupload-ui.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/fileupload/jquery.fileupload-init.js' type='text/javascript'></script>
<!-- / timeago -->
<script src='Contents/Scripts/plugins/timeago/jquery.timeago.js' type='text/javascript'></script>
<!-- / slimscroll -->
<script src='Contents/Scripts/plugins/slimscroll/jquery.slimscroll.min.js' type='text/javascript'></script>
<!-- / autosize (for textareas) -->
<script src='Contents/Scripts/plugins/autosize/jquery.autosize-min.js' type='text/javascript'></script>
<!-- / charCount -->
<script src='Contents/Scripts/plugins/charCount/charCount.js' type='text/javascript'></script>
<!-- / validate -->
<script src='Contents/Scripts/plugins/validate/jquery.validate.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/validate/additional-methods.js' type='text/javascript'></script>
<!-- / naked password -->
<script src='Contents/Scripts/plugins/naked_password/naked_password-0.2.4.min.js' type='text/javascript'></script>
<!-- / nestable -->
<script src='Contents/Scripts/plugins/nestable/jquery.nestable.js' type='text/javascript'></script>
<!-- / tabdrop -->
<script src='Contents/Scripts/plugins/tabdrop/bootstrap-tabdrop.js' type='text/javascript'></script>
<!-- / jgrowl -->
<script src='Contents/Scripts/plugins/jgrowl/jquery.jgrowl.min.js' type='text/javascript'></script>
<!-- / bootbox -->
<script src='Contents/Scripts/plugins/bootbox/bootbox.min.js' type='text/javascript'></script>
<!-- / inplace editing -->
<script src='Contents/Scripts/plugins/xeditable/bootstrap-editable.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/xeditable/wysihtml5.js' type='text/javascript'></script>
<!-- / ckeditor -->
<script src='Contents/Scripts/plugins/ckeditor/ckeditor.js' type='text/javascript'></script>
<!-- / filetrees -->
<script src='Contents/Scripts/plugins/dynatree/jquery.dynatree.min.js' type='text/javascript'></script>
<!-- / datetime picker -->
<script src='Contents/Scripts/plugins/bootstrap_datetimepicker/bootstrap-datetimepicker.js'
        type='text/javascript'></script>
<!-- / daterange picker -->
<script src='Contents/Scripts/plugins/bootstrap_daterangepicker/moment.min.js' type='text/javascript'></script>
<script src='Contents/Scripts/plugins/bootstrap_daterangepicker/bootstrap-daterangepicker.js'
        type='text/javascript'></script>
<!-- / max length -->
<script src='Contents/Scripts/plugins/bootstrap_maxlength/bootstrap-maxlength.min.js' type='text/javascript'></script>
<!-- / dropdown hover -->
<script src='Contents/Scripts/plugins/bootstrap_hover_dropdown/twitter-bootstrap-hover-dropdown.min.js'
        type='text/javascript'></script>
<!-- / slider nav (address book) -->
<script src='Contents/Scripts/plugins/slider_nav/slidernav-min.js' type='text/javascript'></script>
<!-- / fuelux -->
<script src='Contents/Scripts/plugins/fuelux/wizard.js' type='text/javascript'></script>
<!-- / flatty theme -->
<script src='Contents/Scripts/nav.js' type='text/javascript'></script>
<script src='Contents/Scripts/tables.js' type='text/javascript'></script>
<script src='Contents/Scripts/theme.js' type='text/javascript'></script>
<!-- / demo -->
<script src='Contents/Scripts/demo/jquery.mockjax.js' type='text/javascript'></script>
<script src='Contents/Scripts/demo/inplace_editing.js' type='text/javascript'></script>
<script src='Contents/Scripts/demo/charts.js' type='text/javascript'></script>
<script src='Contents/Scripts/demo/demo.js' type='text/javascript'></script>
